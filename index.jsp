...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Savithri Hostels</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Savithri Hostels</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Gajuwaka,chaitanya nagar <br /> Beside CMR central po:530026
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Savithri Hostels</h4>
					<p class="lead mb-0">
						We provide best Accomadation in Gajuwaka
						<a href="https://maps.app.goo.gl/vmikh5HNZk3yREab6">Join Now</a> .
					</p>
				</div>
			</div>
		</div>
